package com.example.guilherme.animations;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView circle = findViewById(R.id.circle_object);
        ImageView sun = findViewById(R.id.sun_object);
        ImageView cloud = findViewById(R.id.cloud_object);
        ImageView alert = findViewById(R.id.alert_object);

        explodeTransition(this, circle);
        fadeTransition(this, cloud);
        rotateView(sun);
    }
